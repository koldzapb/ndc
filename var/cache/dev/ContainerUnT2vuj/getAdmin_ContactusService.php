...
// Returns the public 'admin.contactus' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/ContactUsAdmin.php';
...
$this->factories['admin.contactus'] = function () {
    $instance = new \App\Admin\ContactUsAdmin('admin.contactus', 'App\\Entity\\ContactUs', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Contact Mails');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.contactus.template_registry'] ?? $this->load('getAdmin_Contactus_TemplateRegistryService.php')));
...
return $this->factories['admin.contactus']();
