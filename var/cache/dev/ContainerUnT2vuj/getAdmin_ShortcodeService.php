...
// Returns the public 'admin.shortcode' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/ShortCodeAdmin.php';
...
$this->factories['admin.shortcode'] = function () {
    $instance = new \App\Admin\ShortCodeAdmin('admin.shortcode', 'App\\Entity\\ShortCode', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('ShortCodes');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.shortcode.template_registry'] ?? $this->load('getAdmin_Shortcode_TemplateRegistryService.php')));
...
return $this->factories['admin.shortcode']();
