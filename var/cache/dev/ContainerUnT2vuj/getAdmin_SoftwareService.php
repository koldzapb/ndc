...
// Returns the public 'admin.software' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/SoftwareAdmin.php';
...
$this->factories['admin.software'] = function () {
    $instance = new \App\Admin\SoftwareAdmin('admin.software', 'App\\Entity\\Software', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Software');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.software.template_registry'] ?? $this->load('getAdmin_Software_TemplateRegistryService.php')));
...
return $this->factories['admin.software']();
