...
// Returns the public 'admin.casino' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/CasinoAdmin.php';
...
$this->factories['admin.casino'] = function () {
    $instance = new \App\Admin\CasinoAdmin('admin.casino', 'App\\Entity\\Casino', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Casino');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.casino.template_registry'] ?? $this->load('getAdmin_Casino_TemplateRegistryService.php')));
...
return $this->factories['admin.casino']();
