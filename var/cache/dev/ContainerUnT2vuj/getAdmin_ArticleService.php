...
// Returns the public 'admin.article' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/ArticleAdmin.php';
...
$this->factories['admin.article'] = function () {
    $instance = new \App\Admin\ArticleAdmin('admin.article', 'App\\Entity\\Article', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.article.template_registry'] ?? $this->load('getAdmin_Article_TemplateRegistryService.php')));
...
return $this->factories['admin.article']();
