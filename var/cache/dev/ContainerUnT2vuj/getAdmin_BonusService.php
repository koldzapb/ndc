...
// Returns the public 'admin.bonus' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/BonusAdmin.php';
...
$this->factories['admin.bonus'] = function () {
    $instance = new \App\Admin\BonusAdmin('admin.bonus', 'App\\Entity\\Bonus', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Bonuses');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.bonus.template_registry'] ?? $this->load('getAdmin_Bonus_TemplateRegistryService.php')));
...
return $this->factories['admin.bonus']();
