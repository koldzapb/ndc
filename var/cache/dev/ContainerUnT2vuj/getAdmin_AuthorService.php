...
// Returns the public 'admin.author' autowired service.
...
$this->factories['admin.author'] = function () {
    $instance = new \App\Admin\AuthorAdmin('admin.author', 'App\\Entity\\Author', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.author.template_registry'] ?? $this->load('getAdmin_Author_TemplateRegistryService.php')));
...
return $this->factories['admin.author']();
