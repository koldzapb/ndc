...
// Returns the public 'admin.bonustype' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/BonusTypeAdmin.php';
...
$this->factories['admin.bonustype'] = function () {
    $instance = new \App\Admin\BonusTypeAdmin('admin.bonustype', 'App\\Entity\\BonusType', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Bonus Types');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.bonustype.template_registry'] ?? $this->load('getAdmin_Bonustype_TemplateRegistryService.php')));
...
return $this->factories['admin.bonustype']();
