...
// Returns the public 'admin.news' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/NewsAdmin.php';
...
$this->factories['admin.news'] = function () {
    $instance = new \App\Admin\NewsAdmin('admin.news', 'App\\Entity\\News', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setTemplateRegistry(($this->services['admin.news.template_registry'] ?? $this->load('getAdmin_News_TemplateRegistryService.php')));
...
return $this->factories['admin.news']();
