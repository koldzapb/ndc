...
// Returns the public 'admin.currency' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/CurrencyAdmin.php';
...
$this->factories['admin.currency'] = function () {
    $instance = new \App\Admin\CurrencyAdmin('admin.currency', 'App\\Entity\\Currency', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Currency pages');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.currency.template_registry'] ?? $this->load('getAdmin_Currency_TemplateRegistryService.php')));
...
return $this->factories['admin.currency']();
