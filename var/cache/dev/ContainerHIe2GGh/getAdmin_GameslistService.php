...
// Returns the public 'admin.gameslist' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/GamesListAdmin.php';
...
$this->factories['admin.gameslist'] = function () {
    $instance = new \App\Admin\GamesListAdmin('admin.gameslist', 'App\\Entity\\GamesList', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Games List');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.gameslist.template_registry'] ?? $this->load('getAdmin_Gameslist_TemplateRegistryService.php')));
...
return $this->factories['admin.gameslist']();
