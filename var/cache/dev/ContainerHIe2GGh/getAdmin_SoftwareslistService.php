...
// Returns the public 'admin.softwareslist' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/SoftwaresListAdmin.php';
...
$this->factories['admin.softwareslist'] = function () {
    $instance = new \App\Admin\SoftwaresListAdmin('admin.softwareslist', 'App\\Entity\\SoftwaresList', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Softwares List');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.softwareslist.template_registry'] ?? $this->load('getAdmin_Softwareslist_TemplateRegistryService.php')));
...
return $this->factories['admin.softwareslist']();
