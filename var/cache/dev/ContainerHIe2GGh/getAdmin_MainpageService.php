...
// Returns the public 'admin.mainpage' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/MainPageAdmin.php';
...
$this->factories['admin.mainpage'] = function () {
    $instance = new \App\Admin\MainPageAdmin('admin.mainpage', 'App\\Entity\\MainPage', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Main Pages');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.mainpage.template_registry'] ?? $this->load('getAdmin_Mainpage_TemplateRegistryService.php')));
...
return $this->factories['admin.mainpage']();
