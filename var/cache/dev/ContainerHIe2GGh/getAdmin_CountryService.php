...
// Returns the public 'admin.country' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/CountryAdmin.php';
...
$this->factories['admin.country'] = function () {
    $instance = new \App\Admin\CountryAdmin('admin.country', 'App\\Entity\\Country', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Countries');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.country.template_registry'] ?? $this->load('getAdmin_Country_TemplateRegistryService.php')));
...
return $this->factories['admin.country']();
