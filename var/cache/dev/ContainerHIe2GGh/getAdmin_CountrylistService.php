...
// Returns the public 'admin.countrylist' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/CountryListAdmin.php';
...
$this->factories['admin.countrylist'] = function () {
    $instance = new \App\Admin\CountryListAdmin('admin.countrylist', 'App\\Entity\\CountryList', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Country List');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.countrylist.template_registry'] ?? $this->load('getAdmin_Countrylist_TemplateRegistryService.php')));
...
return $this->factories['admin.countrylist']();
