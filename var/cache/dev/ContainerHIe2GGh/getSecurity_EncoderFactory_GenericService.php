...
include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/Encoder/BasePasswordEncoder.php';
include_once \dirname(__DIR__, 4).'/src/Encoders/CustomPasswordEncoder.php';

return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\User' => new \App\Encoders\CustomPasswordEncoder()]);
