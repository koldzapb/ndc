...
// Returns the public 'admin.bonusvalue' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/BonusValueAdmin.php';
...
$this->factories['admin.bonusvalue'] = function () {
    $instance = new \App\Admin\BonusValueAdmin('admin.bonusvalue', 'App\\Entity\\BonusValue', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Bonus Values Pages');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.bonusvalue.template_registry'] ?? $this->load('getAdmin_Bonusvalue_TemplateRegistryService.php')));
...
return $this->factories['admin.bonusvalue']();
