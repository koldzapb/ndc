...
// Returns the public 'admin.articlecategory' autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Admin/ArticleCategoryAdmin.php';
...
$this->factories['admin.articlecategory'] = function () {
    $instance = new \App\Admin\ArticleCategoryAdmin('admin.articlecategory', 'App\\Entity\\ArticleCategory', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('Article Category');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.articlecategory.template_registry'] ?? $this->load('getAdmin_Articlecategory_TemplateRegistryService.php')));
...
return $this->factories['admin.articlecategory']();
