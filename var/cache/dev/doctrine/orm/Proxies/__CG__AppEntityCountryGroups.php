 ...
 */
class CountryGroups extends \App\Entity\CountryGroups implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CountryGroups' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CountryGroups' . "\0" . 'name', '' . "\0" . 'App\\Entity\\CountryGroups' . "\0" . 'countries', '' . "\0" . 'App\\Entity\\CountryGroups' . "\0" . 'casinos'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CountryGroups $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addCountry(\App\Entity\Country $country)
    {
