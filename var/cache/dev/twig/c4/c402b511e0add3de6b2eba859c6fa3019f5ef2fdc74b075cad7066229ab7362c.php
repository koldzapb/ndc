...
class __TwigTemplate_4970b1bf19b17b8040d5bea1f3a0b3565d1669ff83dc1cc7c3c067a055967cce extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "SonataAdminBundle:Button:create_button.html.twig", "/var/www/ndc_new/vendor/sonata-project/admin-bundle/src/Resources/views/Button/create_button.html.twig");
    }
}
