...
class __TwigTemplate_a178b6b101122dadb32b65b7e81365d77edffb2e603ae3604fc5695342dea8f1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <div id=\"content-404\">
        <div>
            <h1>404</h1>
            <h2>Lost Your Way?</h2>
            <p>We're Gonna Lead On the Safe Path.</p>
            <a href=\"";
        // line 9
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("index");
        echo "\" class=\"btn btn-primary btn-shadow\">TAKE ME HOME</a>
        </div>
    </div>
";
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        ga('create', 'UA-24781904-1', 'nodepositcasino.org');
        ga('send', 'pageview');
...
";
    ...
    {
        return array (  100 => 15,  90 => 14,  76 => 9,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block main %}
    <div id=\"content-404\">
        <div>
            ...
            <h2>Lost Your Way?</h2>
            <p>We're Gonna Lead On the Safe Path.</p>
            <a href=\"{{ path('index') }}\" class=\"btn btn-primary btn-shadow\">TAKE ME HOME</a>
        </div>
    </div>
{% endblock%}
...
{% endblock %}
", "bundles/TwigBundle/Exception/error404.html.twig", "/var/www/ndc_new/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
